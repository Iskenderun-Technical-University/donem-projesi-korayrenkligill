  ...
  return (
    <div className={props.theme ? 'place light' : 'place dark'}>
        ...
        <div className='address'>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d401.1018882932009!2d27.429012310039916!3d38.61515194723091!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14b99c6b9dde1f15%3A0x17105028f1061f19!2zRXJ0dcSfcnVsIERhecSxb8SfbHUgKEvDvGx0w7xyIFNpdGVzaSkgT3RvcGFya8Sx!5e0!3m2!1str!2str!4v1681680956796!5m2!1str!2str" 

            style={{border: "0"}} 
            allowfullscreen="" 
            loading="lazy" 
            referrerpolicy="no-referrer-when-downgrade"></iframe>
            <p className='address-text'>Yarhasanlar, 1706. Sk., 45020 Manisa Merkez/Manisa</p>
        </div>
    </div>
  )
}
